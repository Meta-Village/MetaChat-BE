...
public class MeetingDTO {
    ...
    @Schema(description = "미팅의 고유 ID", example = "123")
    private long meetingId;

    @Schema(description = "미팅이 시작된 시간", example = "2023-09-06T10:00:00")
    private LocalDateTime meetStartTime;

    @Schema(description = "미팅이 종료된 시간", example = "2023-09-06T11:00:00")
    private LocalDateTime meetEndTime;

    @Schema(description = "미팅이 진행된 존의 이름", example = "MainZone")
    private ZoneName zoneName;

    @Schema(description = "미팅이 진행된 월드의 고유 ID", example = "456")

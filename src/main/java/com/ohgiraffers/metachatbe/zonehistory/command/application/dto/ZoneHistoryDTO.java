...
public class ZoneHistoryDTO {
    ...
    @Schema(name = "입장 시간", description = "사용자가 구역에 입장한 시간", example = "2023-09-06T10:00:00")
    private LocalDateTime entryTime;

    @Schema(name = "퇴장 시간", description = "사용자가 구역에서 퇴장한 시간", example = "2023-09-06T11:00:00")
    private LocalDateTime existTime;

    @Schema(name = "존 이름", description = "사용자가 출입한 존의 이름", example = "MainZone")
    private ZoneName zoneName;

    @Schema(name = "사용자 ID", description = "해당 출입 기록을 가진 사용자의 ID", example = "user123")
    private String userId;

    @Schema(name = "월드 ID", description = "사용자가 속한 월드의 ID", example = "456")
